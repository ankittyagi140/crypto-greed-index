...
export default function TermsAndConditions() {
  return (
    <div className="min-h-screen bg-white from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 py-12">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
          ...
          <div className="prose dark:prose-invert max-w-none">
            ...
            <ul className="list-disc pl-6 text-gray-600 dark:text-gray-400 mb-6">
              ...
              <li><strong>Company</strong> (referred to as either &ldquo;the Company&rdquo;, &ldquo;We&rdquo;, &ldquo;Us&rdquo; or &ldquo;Our&rdquo; in this Agreement) refers to cryptogreedindex.com.</li>
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">&ldquo;AS IS&ldquo; and &ldquo;AS AVAILABLE&ldquo; Disclaimer</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">Disputes Resolution</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company.
            </p>

            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">For European Union (EU) Users</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which You are resident.
            </p>

            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">United States Legal Compliance</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">Severability and Waiver</h2>
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-6 mb-3">Severability</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect.
            </p>

            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-6 mb-3">Waiver</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              Except as provided herein, the failure to exercise a right or to require performance of an obligation under these Terms shall not affect a party&rsquo;s ability to exercise such right or require such performance at any time thereafter nor shall the waiver of a breach constitute a waiver of any subsequent breach.
            </p>

            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">Translation Interpretation</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-6">
                These Terms and Conditions may have been translated if We have made them available to You on our Service. You agree that the original English text shall prevail in the case of a dispute.
            </p>

            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">Changes to These Terms and Conditions</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
